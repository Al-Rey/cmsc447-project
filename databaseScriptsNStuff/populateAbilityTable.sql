...
INSERT INTO abilities(FIELD1,ability_name,generation,effects,ability_description) 
VALUES (0,'stench',3,'This Pokémon''s damaging moves have a 10% chance to make the target flinch with each hit if they do not already cause flinching as a secondary effect.
...
the target to flinch.'),
       (1,'drizzle',3,'The weather changes to rain when this Pokémon enters battle and does not end unless replaced by another weather condition.
...
when it enters a battle.'),
       (2,'speed-boost',3,'This Pokémon''s Speed rises one stage after each turn.','Its Speed stat is
gradually boosted.'),
       (3,'battle-armor',3,'Moves cannot score critical hits against this Pokémon.

This ability functions identically to shell armor.','Protects the Pokémon
from critical hits.'),
       (4,'sturdy',3,'When this Pokémon is at full HP, any hit that would knock it out will instead leave it with 1 HP.  Regardless of its current HP, it is also immune to the one-hit KO moves: fissure, guillotine, horn drill, and sheer cold.
...
out with one hit.'),
       (5,'damp',3,'While this Pokémon is in battle, self destruct and explosion will fail and aftermath will not take effect.','Prevents the use of
self-destructing moves.'),
       (6,'limber',3,'This Pokémon cannot be paralyzed.
...
from paralysis.'),
       (7,'sand-veil',3,'During a sandstorm, this Pokémon has 1.25× its evasion, and it does not take sandstorm damage regardless of type.
...
evasion in a sandstorm.'),
       (8,'static',3,'Whenever a move makes contact with this Pokémon, the move''s user has a 30% chance of being paralyzed.
...
may cause paralysis.'),
       (9,'volt-absorb',3,'Whenever an electric-type move hits this Pokémon, it heals for 1/4 of its maximum HP, negating any other effect on it.
...
Electric-type move.'),
       (10,'water-absorb',3,'Whenever a water-type move hits this Pokémon, it heals for 1/4 of its maximum HP, negating any other effect on it.

Water moves will ignore this Pokémon''s substitute.','Restores HP if hit by a
Water-type move.'),
       (11,'oblivious',3,'This Pokémon cannot be infatuated and is immune to captivate.
...
infatuated or falling for taunts.'),
       (12,'cloud-nine',3,'While this Pokémon is in battle, weather can still be in play, but will not have any of its effects.

This ability functions identically to air lock.','Eliminates the effects of weather.'),
       (13,'compound-eyes',3,'This Pokémon''s moves have 1.3× their accuracy.
...
Overworld: If the first Pokémon in the party has this ability, the chance of a wild Pokémon holding a particular item is raised from 50%, 5%, or 1% to 60%, 20%, or 5%, respectively.','Boosts the Pokémon’s accuracy.'),
       (14,'insomnia',3,'This Pokémon cannot be asleep.
...
from falling asleep.'),
       (15,'color-change',3,'Whenever this Pokémon takes damage from a move, the Pokémon''s type changes to match the move.
...
the type of the move used on it.'),
       (16,'immunity',3,'This Pokémon cannot be poisoned.  This includes bad poison.
...
from getting poisoned.'),
       (17,'flash-fire',3,'This Pokémon is immune to fire-type moves.  Once this Pokémon has been hit by a Fire move, its own Fire moves will inflict 1.5× as much damage until it leaves battle.
...
Fire-type moves if it’s hit by one.'),
       (18,'shield-dust',3,'This Pokémon is immune to the extra effects of moves used against it.
...
of attacks taken.'),
       (19,'own-tempo',3,'This Pokémon cannot be confused.
...
from becoming confused.'),
       (20,'suction-cups',3,'This Pokémon cannot be forced out of battle by moves such as whirlwind.
...
that force switching out.'),
       (21,'intimidate',3,'When this Pokémon enters battle, the opponent''s Attack is lowered by one stage.  In a double battle, both opponents are affected.
...
Attack stat.'),
       (22,'shadow-tag',3,'While this Pokémon is in battle, opposing Pokémon cannot flee or switch out.
...
from escaping.'),
       (23,'rough-skin',3,'Whenever a move makes contact with this Pokémon, the move''s user takes 1/8 of its maximum HP in damage.

This ability functions identically to iron barbs.','Inflicts damage to the
attacker on contact.'),
       (24,'wonder-guard',3,'This Pokémon is immune to damaging moves that are not super effective against it.
...
moves will hit.'),
       (25,'levitate',3,'This Pokémon is immune to ground-type moves, spikes, toxic spikes, and arena trap.
...
Ground-type moves.'),
       (26,'effect-spore',3,'Whenever a move makes contact with this Pokémon, the move''s user has a 30% chance of being paralyzed, poisoned, or put to sleep, chosen at random.
...
cause paralysis or sleep.'),
       (27,'synchronize',3,'Whenever this Pokémon is burned, paralyzed, or poisoned, the Pokémon who gave this Pokémon that ailment is also given the ailment.
...
to the Pokémon that inflicted it.'),
       (28,'clear-body',3,'This Pokémon cannot have its stats lowered by other Pokémon.
...
from lowering its stats.'),
       (29,'natural-cure',3,'This Pokémon is cured of any major status ailment when it is switched out for another Pokémon.
...
the Pokémon switches out.'),
       (30,'lightning-rod',3,'All other Pokémon''s single-target electric-type moves are redirected to this Pokémon if it is an eligible target.  Other Pokémon''s Electric moves raise this Pokémon''s Special Attack one stage, negating any other effect on it, and cannot miss it.
...
to boost its Sp. Atk stat.'),
       (31,'serene-grace',3,'This Pokémon''s moves have twice their usual effect chance.
...
additional effects occurring.'),
       (32,'swift-swim',3,'This Pokémon''s Speed is doubled during rain.

This bonus does not count as a stat modifier.','Boosts the Pokémon’s
Speed stat in rain.'),
       (33,'chlorophyll',3,'This Pokémon''s Speed is doubled during strong sunlight.

This bonus does not count as a stat modifier.','Boosts the Pokémon’s
Speed stat in sunshine.'),
       (34,'illuminate',3,'Overworld: If the lead Pokémon has this ability, the wild encounter rate is doubled.

This ability has no effect in battle.','Raises the likelihood of
meeting wild Pokémon.'),
       (35,'trace',3,'When this Pokémon enters battle, it copies a random opponent''s ability.
...
opposing Pokémon’s Ability.'),
       (36,'huge-power',3,'This Pokémon''s Attack is doubled while in battle.

This bonus does not count as a stat modifier.

This ability functions identically to pure power.','Boosts the Pokémon’s
Attack stat.'),
       (37,'poison-point',3,'Whenever a move makes contact with this Pokémon, the move''s user has a 30% chance of being poisoned.','Contact with the Pokémon
may poison the attacker.'),
       (38,'inner-focus',3,'This Pokémon cannot flinch.','Protects the Pokémon
from flinching.'),
       (39,'magma-armor',3,'This Pokémon cannot be frozen.
...
from becoming frozen.'),
       (40,'water-veil',3,'This Pokémon cannot be burned.
...
from getting a burn.'),
       (41,'magnet-pull',3,'While this Pokémon is in battle, opposing steel-type Pokémon cannot flee or switch out.
...
Pokémon from escaping.'),
       (42,'soundproof',3,'This Pokémon is immune to moves flagged as being sound-based.
...
sound-based moves.'),
       (43,'rain-dish',3,'This Pokémon heals for 1/16 of its maximum HP after each turn during rain.','The Pokémon gradually
regains HP in rain.'),
       (44,'sand-stream',3,'The weather changes to a sandstorm when this Pokémon enters battle and does not end unless cancelled by another weather condition.
...
sandstorm in battle.'),
       (45,'pressure',3,'Moves targetting this Pokémon use one extra PP.
...
Pokémon’s PP usage.'),
       (46,'thick-fat',3,'This Pokémon takes half as much damage from fire- and ice-type moves.','Boosts resistance to Fire-
and Ice-type moves.'),
       (47,'early-bird',3,'This Pokémon''s remaining sleep turn count falls by 2 rather than 1.

If this Pokémon''s sleep counter is at 1, it will fall to 0 and then the Pokémon will wake up.','The Pokémon awakens
quickly from sleep.'),
       (48,'flame-body',3,'Whenever a move makes contact with this Pokémon, the move''s user has a 30% chance of being burned.
...
may burn the attacker.'),
       (49,'run-away',3,'This Pokémon is always successful fleeing from wild battles, even if trapped by a move or ability.','Enables a sure getaway
from wild Pokémon.'),
       (50,'keen-eye',3,'This Pokémon cannot have its accuracy lowered.
...
from lowering accuracy.'),
       (51,'hyper-cutter',3,'This Pokémon''s Attack cannot be lowered by other Pokémon.
...
from lowering its Attack stat.'),
       (52,'pickup',3,'At the end of each turn, if another Pokémon consumed or Flung a held item that turn, this Pokémon picks up the item if it is not already holding one.  After each battle, this Pokémon has a 10% chance of picking up an item if it is not already holding one.
...
pick up items.'),
       (53,'truant',3,'Every second turn on which this Pokémon should attempt to use a move, it will instead do nothing ("loaf around").
...
on consecutive turns.'),
       (54,'hustle',3,'This Pokémon''s physical moves do 1.5× as much regular damage, but have 0.8× their usual accuracy.
...
but lowers accuracy.'),
       (55,'cute-charm',3,'Whenever a move makes contact with this Pokémon, the move''s user has a 30% chance of being infatuated.
...
may cause infatuation.'),
       (56,'plus',3,'This Pokémon has 1.5× its Special Attack if any friendly Pokémon has plus or minus.
...
Pokémon has Plus or Minus.'),
       (57,'minus',3,'This Pokémon has 1.5× its Special Attack if any friendly Pokémon has plus or minus.

This bonus does not count as a stat modifier.  If either ability is disabled by gastro acid, both lose their effect.','Boosts the Sp. Atk stat if another
Pokémon has Plus or Minus.'),
       (58,'forecast',3,'During rain, strong sunlight, or hail, this Pokémon''s type changes to water, fire, or ice, respectively, and its form changes to match.
...
the weather.'),
       (59,'sticky-hold',3,'This Pokémon''s hold item cannot be removed by other Pokémon.
...
from item theft.'),
       (60,'shed-skin',3,'After each turn, this Pokémon has a 33% of being cured of any major status ailment.','The Pokémon may heal its
own status conditions.'),
       (61,'guts',3,'Whenever this Pokémon is asleep, burned, paralyzed, or poisoned, it has 1.5× its Attack.  This Pokémon is not affected by the usual Attack cut from a burn.

This bonus does not count as a stat modifier.','Boosts the Attack stat if the
Pokémon has a status condition.'),
       (62,'marvel-scale',3,'Whenever this Pokémon has a major status ailment, it has 1.5× its Defense.

This bonus does not count as a stat modifier.','Boosts the Defense stat if the
Pokémon has a status condition.'),
       (63,'liquid-ooze',3,'Whenever a Pokémon would heal after hitting this Pokémon with a leeching move like absorb, it instead loses as many HP as it would usually gain.

dream eater is unaffected.','Damages attackers
using any draining move.'),
       (64,'overgrow',3,'When this Pokémon has 1/3 or less of its HP remaining, its grass-type moves inflict 1.5× as much regular damage.','Powers up Grass-type moves
when the Pokémon is in trouble.'),
       (65,'blaze',3,'When this Pokémon has 1/3 or less of its HP remaining, its fire-type moves inflict 1.5× as much regular damage.','Powers up Fire-type moves when
the Pokémon is in trouble.'),
       (66,'torrent',3,'When this Pokémon has 1/3 or less of its HP remaining, its water-type moves inflict 1.5× as much regular damage.','Powers up Water-type moves
when the Pokémon is in trouble.'),
       (67,'swarm',3,'When this Pokémon has 1/3 or less of its HP remaining, its bug-type moves inflict 1.5× as much regular damage.

Overworld: If the lead Pokémon has this ability, the wild encounter rate is increased.','Powers up Bug-type moves when
the Pokémon is in trouble.'),
       (68,'rock-head',3,'This Pokémon does not receive recoil damage from its recoil moves.
...
from recoil damage.'),
       (69,'drought',3,'The weather changes to strong sunlight when this Pokémon enters battle and does not end unless cancelled by another weather condition.
...
the Pokémon enters a battle.'),
       (70,'arena-trap',3,'While this Pokémon is in battle, opposing Pokémon cannot flee or switch out.  flying-type Pokémon and Pokémon in the air, e.g. due to levitate or magnet rise, are unaffected.

Pokémon with run away can still flee.  Pokémon can still switch out with the use of a move or item.

Overworld: If the lead Pokémon has this ability, the wild encounter rate is doubled.','Prevents opposing Pokémon
from fleeing.'),
       (71,'vital-spirit',3,'This Pokémon cannot be asleep.
...
from falling asleep.'),
       (72,'white-smoke',3,'This Pokémon cannot have its stats lowered by other Pokémon.
...
from lowering its stats.'),
       (73,'pure-power',3,'This Pokémon''s Attack is doubled in battle.

This bonus does not count as a stat modifier.

This ability functions identically to huge power.','Boosts the Pokémon’s
Attack stat.'),
       (74,'shell-armor',3,'Moves cannot score critical hits against this Pokémon.

This ability functions identically to battle armor.','Protects the Pokémon
from critical hits.'),
       (75,'air-lock',3,'While this Pokémon is in battle, weather can still be in play, but will not have any of its effects.

This ability functions identically to cloud nine.','Eliminates the effects of weather.'),
       (76,'tangled-feet',4,'When this Pokémon is confused, it has twice its evasion.','Raises evasion if the
Pokémon is confused.'),
       (77,'motor-drive',4,'Whenever an electric-type move hits this Pokémon, its Speed rises one stage, negating any other effect on it.
...
hit by an Electric-type move.'),
       (78,'rivalry',4,'This Pokémon inflicts 1.25× as much regular damage against Pokémon of the same gender and 0.75× as much regular damage against Pokémon of the opposite gender.

If either Pokémon is genderless, damage is unaffected.','Deals more damage to Pokémon
of the same gender.'),
       (79,'steadfast',4,'Whenever this Pokémon flinches, its Speed rises one stage.','Boosts the Speed stat each time
the Pokémon flinches.'),
       (80,'snow-cloak',4,'During hail, this Pokémon has 1.25× its evasion, and it does not take hail damage regardless of type.

The evasion bonus does not count as a stat modifier.

Overworld: If the lead Pokémon has this ability, the wild encounter rate is halved in snow.','Boosts evasion in a hailstorm.'),
       (81,'gluttony',4,'This Pokémon eats any held Berry triggered by low HP when it falls below 50% of its HP, regardless of the Berry''s usual threshold.','Makes the Pokémon use a held
Berry earlier than usual.'),
       (82,'anger-point',4,'Whenever this Pokémon receives a critical hit, its Attack rises to the maximum of 6 stages.
...
the Pokémon takes a critical hit.'),
       (83,'unburden',4,'When this Pokémon uses or loses its held item, its Speed is doubled.  If it gains another item or leaves battle, this bonus is lost.
...
held item is used or lost.'),
       (84,'heatproof',4,'This Pokémon takes half as much damage from fire-type moves and burns.','Weakens the power of
Fire-type moves.'),
       (85,'simple',4,'Each stage of this Pokémon''s stat modifiers acts as two stages.  These doubled stages are still limited to a minimum of -6 and a maximum of 6.
...
wild stat changes.'),
       (86,'dry-skin',4,'This Pokémon takes 1/8 of its maximum HP in damage after each turn during strong sunlight, but it heals for 1/8 of its HP each turn during rain.  This Pokémon takes 1.25× as much damage from fire-type moves, but whenever a water move hits it, it heals for 1/4 its maximum HP instead.','Reduces HP if it’s hot.
Water restores HP.'),
       (87,'download',4,'When this Pokémon enters battle, its Attack or Special Attack, whichever corresponds to its opponents'' weaker total defensive stat, rises one stage.  In the event of a tie, Special Attack is raised.

This ability also takes effect when acquired during a battle.','Adjusts power based on an
opposing Pokémon’s stats.'),
       (88,'iron-fist',4,'Moves flagged as being punch-based have 1.2× their base power for this Pokémon.
...
sucker punch is not flagged as punch-based, its original, Japanese name only means "surprise attack".','Powers up punching moves.'),
       (89,'poison-heal',4,'If this Pokémon is poisoned, it will heal for 1/8 of its maximum HP after each turn rather than taking damage.  This includes bad poison.','Restores HP if the
Pokémon is poisoned.'),
       (90,'adaptability',4,'This Pokémon inflicts twice as much damage with moves whose types match its own, rather than the usual same-type attack bonus of 1.5×.','Powers up moves of the
same type as the Pokémon.'),
       (91,'skill-link',4,'This Pokémon always hits five times with two-to-five-hit moves, such as icicle spear.  It also bypasses the accuracy checks on triple kick''s second and third hits.','Increases the number of times
multi-strike moves hit.'),
       (92,'hydration',4,'This Pokémon is cured of any major status ailment after each turn during rain.','Heals status conditions if
it’s raining.'),
       (93,'solar-power',4,'During strong sunlight, this Pokémon has 1.5× its Special Attack but takes 1/8 of its maximum HP in damage after each turn.','Boosts the Sp. Atk stat in sunny
weather, but HP decreases.'),
       (94,'quick-feet',4,'Whenever this Pokémon has a major status ailment, it has 1.5× its Speed.  This Pokémon is not affected by the usual Speed cut from paralysis.

Overworld: If the lead Pokémon has this ability, the wild encounter rate is halved.','Boosts the Speed stat if the
Pokémon has a status condition.'),
       (95,'normalize',4,'This Pokémon''s moves all act as if they were normal-type.
...
become Normal type.'),
       (96,'sniper',4,'This Pokémon inflicts triple damage with critical hits, rather than the usual double damage.','Powers up moves if they
become critical hits.'),
       (97,'magic-guard',4,'This Pokémon is immune to damage not directly caused by a move.
...
damage from attacks.'),
       (98,'no-guard',4,'Moves used by or against this Pokémon never miss.
...
against the Pokémon will land.'),
       (99,'stall',4,'This Pokémon moves last within its priority bracket.
...
all other Pokémon do.'),
       (100,'technician',4,'This Pokémon''s moves have 1.5× their power if their base power is 60 or less.
...
weaker moves.'),
       (101,'leaf-guard',4,'This Pokémon cannot be given a major status ailment during strong sunlight.
...
in sunny weather.'),
       (102,'klutz',4,'In battle, this Pokémon cannot use its held item, nor will the item have any passive effect on the battle, positive or negative.  This Pokémon also cannot use fling.
...
any held items.'),
       (103,'mold-breaker',4,'This Pokémon''s moves completely ignore abilities that could hinder or prevent their effect on the target.
...
regardless of its Abilities.'),
       (104,'super-luck',4,'This Pokémon''s moves have critical hit rates one stage higher than normal.','Boosts the critical-hit
ratios of moves.'),
       (105,'aftermath',4,'When this Pokémon is knocked out by a move that makes contact, the move''s user takes 1/4 its maximum HP in damage.','Damages the attacker
landing the finishing hit.'),
       (106,'anticipation',4,'When this Pokémon enters battle, if one of its opponents has a move that is super effective against it, self destruct, explosion, or a one-hit knockout move, all participating trainers are notified.
...
dangerous moves.'),
       (107,'forewarn',4,'When this Pokémon enters battle, it reveals the move with the highest base power known by any opposing Pokémon to all participating trainers.
...
an opposing Pokémon has.'),
       (108,'unaware',4,'This Pokémon ignores other Pokémon''s stat modifiers for the purposes of damage and accuracy calculation.
...
Pokémon’s stat changes.'),
       (109,'tinted-lens',4,'This Pokémon deals twice as much damage with moves that are not very effective against the target.','Powers up “not very
effective” moves.'),
       (110,'filter',4,'This Pokémon takes 0.75× as much damage from moves that are super effective against it.

This ability functions identically to solid rock.','Reduces damage from
supereffective attacks.'),
       (111,'slow-start',4,'This Pokémon''s Attack and Speed are halved for five turns upon entering battle.
...
Attack and Speed stats.'),
       (112,'scrappy',4,'This Pokémon ignores ghost-type Pokémon''s immunity to normal- and fighting-type moves.

Ghost Pokémon''s other types affect damage as usual.','Makes Normal- and Fighting-type
moves hit Ghost-type Pokémon.'),
       (113,'storm-drain',4,'All other Pokémon''s single-target water-type moves are redirected to this Pokémon, if it is an eligible target.  Other Pokémon''s Water moves raise this Pokémon''s Special Attack one stage, negating any other effect on it, and cannot miss it.

If the move''s intended target also has this ability, the move is not redirected.  When multiple Pokémon with this ability are possible targets for redirection, the move is redirected to the one with the highest Speed stat, or, in the case of a tie, to a random tied Pokémon.  follow me takes precedence over this ability.','Draws in all Water-type moves
to boost its Sp. Atk stat.'),
       (114,'ice-body',4,'This Pokémon heals for 1/16 of its maximum HP after each turn during hail, and it does not take hail damage regardless of type.','The Pokémon gradually
regains HP in a hailstorm.'),
       (115,'solid-rock',4,'This Pokémon takes 0.75× as much damage from moves that are super effective against it.

This ability functions identically to filter.','Reduces damage from
supereffective attacks.'),
       (116,'snow-warning',4,'The weather changes to hail when this Pokémon enters battle and does not end unless cancelled by another weather condition.
...
hailstorm when it enters a battle.'),
       (117,'honey-gather',4,'This Pokémon has a chance of picking up honey after each battle.  This chance starts at 5% and rises another 5% after every tenth level: 5% from level 1–10, 10% from 11–20, and so on, up to 50% from 91–100.
...
Honey from somewhere.'),
       (118,'frisk',4,'When this Pokémon enters battle, it reveals an opposing Pokémon''s held item to all participating trainers.
...
opposing Pokémon’s held item.'),
       (119,'reckless',4,'This Pokémon''s recoil moves and crash moves have 1.2× their base power.
...
have recoil damage.'),
       (120,'multitype',4,'If this Pokémon is holding an elemental Plate, its type and form change to match the Plate.
...
to match the Plate it holds.'),
       (121,'flower-gift',4,'Friendly Pokémon have 1.5× their Attack and Special Defense during strong sunlight if any friendly Pokémon has this ability.
...
when it is sunny.'),
       (122,'bad-dreams',4,'Opposing Pokémon take 1/8 of their maximum HP in damage after each turn while they are asleep.','Reduces the HP of sleeping
opposing Pokémon.'),
       (123,'pickpocket',5,'Whenever a move makes contact with this Pokémon, if it does not have a held item, it steals the attacker''s held item.
...
that made direct contact.'),
       (124,'sheer-force',5,'This Pokémon''s moves with extra effects have 1.3× their power, but lose their extra effects.

An effect chance is a move''s chance to inflict a status ailment, cause a stat change, or make the target flinch in addition to the move''s main effect. For example, thunder shock''s paralysis is an extra effect, but thunder wave''s is not, nor are knock off''s item removal and air cutter''s increased critical hit rate.

Moves that lower the user''s stats are unaffected.','Removes additional effects to
increase move damage.'),
       (125,'contrary',5,'Whenever this Pokémon''s stats would be raised, they are instead lowered by the same amount, and vice versa.','Makes stat changes have
an opposite effect.'),
       (126,'unnerve',5,'Opposing Pokémon cannot eat held Berries while this Pokémon is in battle.
...
makes them unable to eat Berries.'),
       (127,'defiant',5,'When any of this Pokémon''s stats are lowered, its Attack rises by two stages.
...
when its stats are lowered.'),
       (128,'defeatist',5,'This Pokémon''s Attack and Special Attack are halved when it has half its HP or less.','Lowers stats when HP
becomes half or less.'),
       (129,'cursed-body',5,'Moves that hit this Pokémon have a 30% chance of being Disabled afterward.','May disable a move used
on the Pokémon.'),
       (130,'healer',5,'Friendly Pokémon next to this Pokémon in double and triple battles each have a 30% chance of being cured of any major status ailment after each turn.','Sometimes heals an
ally’s status condition.'),
       (131,'friend-guard',5,'All friendly Pokémon take 0.75× as much direct damage from moves while this Pokémon is in battle.

This effect stacks if multiple allied Pokémon have it.','Reduces damage done to allies.'),
       (132,'weak-armor',5,'Whenever a physical move hits this Pokémon, its Speed rises one stage and its Defense falls one stage.
...
stat and raise its Speed stat.'),
       (133,'heavy-metal',5,'This Pokémon has double the usual weight for its species.','Doubles the Pokémon’s weight.'),
       (134,'light-metal',5,'This Pokémon has half the usual weight for its species.','Halves the Pokémon’s weight.'),
       (135,'multiscale',5,'This Pokémon takes half as much damage when it is hit having full HP.','Reduces the damage taken by the
Pokémon when its HP is full.'),
       (136,'toxic-boost',5,'This Pokémon has 1.5× its Attack when poisoned.','Powers up physical attacks when
the Pokémon is poisoned.'),
       (137,'flare-boost',5,'This Pokémon has 1.5× its Special Attack when burned.','Powers up special attacks when
the Pokémon is burned.'),
       (138,'harvest',5,'After each turn, if the last item this Pokémon consumed was a Berry and it is not currently holding an item, it has a 50% chance of regaining that Berry, or a 100% chance during strong sunlight.','May create another
Berry after one is used.'),
       (139,'telepathy',5,'This Pokémon does not take damage from friendly Pokémon''s moves, including single-target moves aimed at it.','Anticipates an ally’s
attack and dodges it.'),
       (140,'moody',5,'After each turn, one of this Pokémon''s stats at random rises two stages, and another falls one stage.
...
lowers another.'),
       (141,'overcoat',5,'This Pokémon does not take damage from weather.','Protects the Pokémon from things
like sand, hail, and powder.'),
       (142,'poison-touch',5,'This Pokémon''s contact moves have a 30% chance of poisoning the target with each hit.
...
Pokémon makes contact.'),
       (143,'regenerator',5,'This Pokémon regains 1/3 of its maximum HP when it is switched out for another Pokémon under any circumstances other than having fainted.

This ability does not take effect when a battle ends.','Restores a little HP when
withdrawn from battle.'),
       (144,'big-pecks',5,'This Pokémon''s Defense cannot be lowered by other Pokémon.
...
Defense-lowering attacks.'),
       (145,'sand-rush',5,'This Pokémon''s Speed is doubled during a sandstorm, and it does not take sandstorm damage, regardless of type.','Boosts the Pokémon’s
Speed stat in a sandstorm.'),
       (146,'wonder-skin',5,'Non-damaging moves have exactly 50% base accuracy against this Pokémon.','Makes status moves
more likely to miss.'),
       (147,'analytic',5,'This Pokémon''s moves have 1.3× their power when it moves last in a turn.

future sight and doom desire are unaffected.','Boosts move power when the
Pokémon moves after the target.'),
       (148,'illusion',5,'This Pokémon, upon being sent out, appears to have the species, nickname, and Poké Ball of the last Pokémon in the party that is able to battle.  This illusion breaks upon being hit by a damaging move.
...
Pokémon in the party’s last spot.'),
       (149,'imposter',5,'This Pokémon transforms into a random opponent upon entering battle.  This effect is identical to the move transform.','The Pokémon transforms itself
into the Pokémon it’s facing.'),
       (150,'infiltrator',5,'This Pokémon''s moves ignore light screen, reflect, and safeguard.','Passes through the opposing
Pokémon’s barrier and strikes.'),
       (151,'mummy',5,'Whenever a contact move hits this Pokémon, the attacking Pokémon''s ability changes to Mummy.
...
spreads this Ability.'),
       (152,'moxie',5,'This Pokémon''s Attack rises one stage upon knocking out another Pokémon, even a friendly Pokémon.
...
knocking out any Pokémon.'),
       (153,'justified',5,'Whenever a dark-type move hits this Pokémon, its Attack rises one stage.

The move is not negated in any way.','Boosts the Attack stat when
it’s hit by a Dark-type move.'),
       (154,'rattled',5,'This Pokémon''s Speed rises one stage with each hit from a damaging dark-, ghost-, or bug-type move.','Some move types scare
it and boost its Speed stat.'),
       (155,'magic-bounce',5,'When this Pokémon is targeted by a move flagged as being reflectable, the move is redirected to its user.
...
A move reflected by this ability or magic coat cannot be reflected back.','Reflects status moves.'),
       (156,'sap-sipper',5,'Whenever a grass-type move hits this Pokémon, its Attack rises one stage, negating any other effect on it.','Boosts the Attack stat when hit
by a Grass-type move.'),
       (157,'prankster',5,'This Pokémon''s non-damaging moves have their priority increased by one stage.','Gives priority to a status move.'),
       (158,'sand-force',5,'During a sandstorm, this Pokémon''s rock-, ground-, and steel-type moves have 1.3× their base power.  This Pokémon does not take sandstorm damage, regardless of type.','Boosts certain moves’
power in a sandstorm.'),
       (159,'iron-barbs',5,'Whenever a move makes contact with this Pokémon, the move''s user takes 1/8 of its maximum HP in damage.

This ability functions identically to rough skin.','Inflicts damage to the
attacker on contact.'),
       (160,'zen-mode',5,'This Pokémon switches between Standard Mode and Zen Mode after each turn depending on its HP.  Below 50% of its maximum HP, it switches to Zen Mode, and at 50% or above, it switches to Standard Mode.
...
shape when HP is half or less.'),
       (161,'victory-star',5,'All friendly Pokémon''s moves, including this Pokémon''s own moves, have 1.1× their usual accuracy while this Pokémon is in battle.','Boosts the accuracy of its
allies and itself.'),
       (162,'turboblaze',5,'This Pokémon''s moves completely ignore abilities that could hinder or prevent their effect on the target.
...
regardless of its Abilities.'),
       (163,'teravolt',5,'This Pokémon''s moves completely ignore abilities that could hinder or prevent their effect on the target.
